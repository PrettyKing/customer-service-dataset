...
```text
customer-service-qlora/mac/data/train.jsonl  # 54 条训练样本
customer-service-qlora/mac/data/valid.jsonl  # 11 条验证样本
```
...
mlx_lm.lora \
    ...
    --adapter-path ./customer-service-qlora/mac/training/adapters \
    --iters 300 \
    --batch-size 1 \
    --num-layers 16
```
...
mlx_lm.fuse \
    --model mlx-community/Qwen2.5-14B-Instruct-4bit \
    --adapter-path ./customer-service-qlora/mac/training/adapters \
    --save-path ./customer-service-qlora/mac/models/mlx-4bit/qwen-customer-service-merged
```
...
mlx_lm.fuse \
    --model mlx-community/Qwen2.5-14B-Instruct-4bit \
    --adapter-path ./customer-service-qlora/mac/training/adapters \
    --save-path ./customer-service-qlora/mac/models/mlx-f16/qwen-customer-service-merged-f16 \
    --dequantize
```
...
python convert_hf_to_gguf.py \
    /Users/chalee/Desktop/customer-service-dataset/customer-service-qlora/mac/models/mlx-f16/qwen-customer-service-merged-f16 \
    --outfile /Users/chalee/Desktop/customer-service-dataset/customer-service-qlora/mac/models/gguf/qwen-customer-service-f16.gguf \
    --outtype f16
...
./build/bin/llama-quantize \
    /Users/chalee/Desktop/customer-service-dataset/customer-service-qlora/mac/models/gguf/qwen-customer-service-f16.gguf \
    /Users/chalee/Desktop/customer-service-dataset/customer-service-qlora/mac/models/gguf/qwen-customer-service-q4_K_M.gguf \
    Q4_K_M
```

如果 `customer-service-qlora/mac/llama.cpp` 不存在,先在项目内克隆:

```bash
cd /Users/chalee/Desktop/customer-service-dataset/customer-service-qlora/mac
git clone https://github.com/ggml-org/llama.cpp.git
```

创建 Modelfile:
```
FROM /Users/chalee/Desktop/customer-service-dataset/customer-service-qlora/mac/models/gguf/qwen-customer-service-q4_K_M.gguf
...
```bash
cd /Users/chalee/Desktop/customer-service-dataset
ollama create qwen-customer-service -f customer-service-qlora/mac/ollama/Modelfile
